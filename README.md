...
This module provisions an Azure API Management certificate. These certificates can be used for authentication with backends.

Not to be confused with the CA certificates that can be added with the `tf-azurerm-module_primitive-api_management` module
